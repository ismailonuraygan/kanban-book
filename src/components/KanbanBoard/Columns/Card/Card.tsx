      ...
      <div className={open ? styles.bodyOpen : styles.body}>
        <div className={styles.content}>
          <div className={styles.cardContent}>
            {book.edition_count && <div className={styles.editions}>{book.edition_count} Editions</div>}
            <p>First Published: {book.first_publish_year}</p>
          </div>
          <div className={styles.cardFooter}>
            <div className={styles.pages}>
              {book.number_of_pages_median && <LayersOutlinedIcon style={{ width: "14px" }} />}
              {book.number_of_pages_median && <p>{book.number_of_pages_median} pages</p>}
            </div>
